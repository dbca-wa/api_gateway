...
class APIService(models.Model):
    ...
    service_slug_url = models.CharField(max_length=1024, help_text="Choose a url slug name which will binded to this api, eg(dbca-locations-data)") 
    ...
    cache_limit = models.IntegerField(help_text="Cache expiry limit in seconds", default=0)
